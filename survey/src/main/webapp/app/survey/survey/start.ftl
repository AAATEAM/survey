...
<input type="hidden" value="${rhs["examarrangeId"]?if_exists}" name="examarrangeid" />
<input type="hidden" value="${rhs["paper"].id?if_exists}" name="paperid" />
<input type="hidden" value="${rhs["method"]?if_exists}" name="method" />
...
<div class="exam-frame">
	...
	<div class="alert alert-success">
		...
		<#list rhs["singleitems"] as singleitem>
			<tr>
				<td><strong>${singleitem_index+1}.&nbsp;${singleitem.content}</strong><div class="pull-right"></div></td>
			<tr>
	     ...
	     <div class="alert alert-success">
		    ...
		    <#list rhs["multiitems"] as multiitem>
		    	<tr>
					...
					<td><strong>${multiitem_index+1}.&nbsp;${multiitem.content}</strong><div class="pull-right"></div></td>
				<tr>
     ...
     <#if (rhs["blankitems"]?size > 0 )>
	     ...
	     <div class="alert alert-success">
		    ...
		    <#list rhs["blankitems"]?sort_by("id") as blankitem>
		    	<tr>
					<td><strong>${blankitem_index+1}.&nbsp;${blankitem.content}</strong><div class="pull-right"></div></td>
				<tr>
				<tr>
	     ...
	     <div class="alert alert-success">
	     	<table width="100%">  
	      	<#list rhs["essayitems"]?sort_by("id") as essayitem>
	      		<tr>
					<td><strong>${essayitem_index+1}.&nbsp;${essayitem.content}</strong><div class="pull-right"></div></td>
				<tr>
				<tr>
...
<script>
	...
	function refresh(){
		window.opener.location.href = 'survey_survey_survey_complete.do';
		window.close();
		//alert("refresh");
	}
